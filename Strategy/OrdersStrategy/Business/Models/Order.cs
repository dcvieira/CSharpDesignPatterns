using OrdersStrategy.Business.Strategies.Invoice;
using OrdersStrategy.Business.Strategies.SaleTax;
using OrdersStrategy.Business.Strategies.Shipping;
using System;
...
namespace OrdersStrategy.Business.Models
{
    public class Order
    {
        ...
        // Alternative approach to use Strategy Pattern
        public decimal GetTax(ISalesTaxStrategy? salesStrategy = default)
        {
            ...
            return salesStrategy.GetTaxFor(this);
        }
